...
impl Service {
    ...
    async fn record_local_history(&mut self, content: syntra_store::HistoryContent) {
    ...
    fn send_peer(&self, peer: Peer, event: syntra_proto::ProtoEvent) {
        match peer {
    ...
    async fn handle_peer_protocol(&mut self, peer: Peer, event: syntra_proto::ProtoEvent) {
    ...
    fn handle_file_protocol(&mut self, peer: Peer, event: syntra_proto::ProtoEvent) {
        use syntra_proto::ProtoEvent;
        match event {
