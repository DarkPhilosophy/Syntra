...
pub struct AppViewState {
    ...
    pub peer_profiles: BTreeMap<String, Arc<lan_mouse_ipc::DeviceProfile>>,
    pub discovered_peers: Vec<lan_mouse_ipc::DiscoveredPeer>,
    pub authorization: HashMap<String, String>,
    pub input_health: InputHealth,
    pub input_sharing: Option<bool>,
    pub clipboard: ClipboardSettings,
    pub history_page: Option<lan_mouse_ipc::HistoryPage>,
    ...
    pub history_images: BTreeMap<(String, u64), Arc<lan_mouse_ipc::HistoryImage>>,
    pub transfers: BTreeMap<(ClipboardTransferId, ClipboardFileId), ClipboardTransferStatus>,
    pub file_receive_settings: Option<lan_mouse_ipc::FileReceiveSettings>,
    pub file_receive_error: Option<String>,
    pub file_receive_pending: bool,
    pub manual_transfers: BTreeMap<(String, u64), lan_mouse_ipc::ManualTransferStatus>,
    pub pending_file_offers: Vec<lan_mouse_ipc::IncomingFileOffer>,
    ...
    pub fn reduce_transport(&mut self, e: TransportLifecycleEvent) {
        ...
        if !self.status.connected {
            ...
            self.manual_transfers.retain(|_, transfer| {
                matches!(
                    transfer.state,
                    lan_mouse_ipc::ManualTransferState::Completed
                        | lan_mouse_ipc::ManualTransferState::Declined
                        | lan_mouse_ipc::ManualTransferState::Cancelled
                        | lan_mouse_ipc::ManualTransferState::Failed
                )
            });
        }
    }
    pub fn reduce(&mut self, e: FrontendEvent) {
        match e {
            ...
            FrontendEvent::ManualTransferStatus(status) => {
                if !matches!(
                    status.state,
                    lan_mouse_ipc::ManualTransferState::AwaitingAcceptance
                ) {
...
mod tests {
    ...
    fn manual_offer_replay_and_decision_preserve_other_peers() {
        let first = lan_mouse_ipc::IncomingFileOffer {
        ...
        let second = lan_mouse_ipc::IncomingFileOffer {
        ...
        let pending = lan_mouse_ipc::ManualTransferStatus {
            peer_fingerprint: first.peer_fingerprint.clone(),
            transfer_id: first.transfer_id,
            file_name: first.file_name.clone(),
            size: first.size,
            transferred: 0,
            direction: lan_mouse_ipc::ClipboardTransferDirection::Receiving,
            state: lan_mouse_ipc::ManualTransferState::AwaitingAcceptance,
            destination: None,
        ...
        view.reduce(FrontendEvent::ManualTransferStatus(
            lan_mouse_ipc::ManualTransferStatus {
                state: lan_mouse_ipc::ManualTransferState::Transferring,
                error: None,
                ..pending
            },
        ));
    ...
    fn lost_service_clears_stale_incoming_file_prompts() {
        ...
        view.reduce(FrontendEvent::IncomingFileOffer(
            lan_mouse_ipc::IncomingFileOffer {
    ...
    fn history_page(query: &str, sequences: &[u64]) -> lan_mouse_ipc::HistoryPage {
        lan_mouse_ipc::HistoryPage {
            query: query.into(),
            offset: 0,
            next_offset: None,
            records: sequences
                .iter()
                .map(|sequence| lan_mouse_ipc::HistoryRecordSummary {
                    event_id: lan_mouse_ipc::HistoryEventId {
                    ...
                    pinned: *sequence == 2,
                    kind: lan_mouse_ipc::HistoryKind::Text,
                    preview: lan_mouse_ipc::HistoryPreview::Text {
                        preview: "needle".into(),
                        truncated: false,
                    },
                })
