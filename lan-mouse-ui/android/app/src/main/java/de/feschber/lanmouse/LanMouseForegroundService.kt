...
class LanMouseForegroundService : Service() {
    ...
    companion object {
        const val ACTION_START = "de.feschber.lanmouse.action.START_FOREGROUND_SERVICE"
        const val ACTION_STOP = "de.feschber.lanmouse.action.STOP_FOREGROUND_SERVICE"

        private const val CHANNEL = "lan_mouse_connection"
