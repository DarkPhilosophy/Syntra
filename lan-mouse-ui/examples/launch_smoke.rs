...
fn snapshot(app: &lan_mouse_ui::app::AppWindow, name: &str) {
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let app = lan_mouse_ui::app::create_app()?;
    app.global::<lan_mouse_ui::app::Translations>()
    ...
    timer.start(
        ...
        move || {
            ...
            slint::Timer::single_shot(std::time::Duration::from_millis(500), move || {
                ...
                let theme = app.global::<lan_mouse_ui::app::Theme>();
                ...
                slint::Timer::single_shot(std::time::Duration::from_millis(100), move || {
                    ...
                    println!(
                        ...
                        app.global::<lan_mouse_ui::app::Theme>().get_base_mode(),
                        app.global::<lan_mouse_ui::app::Theme>().get_palette(),
                    );
